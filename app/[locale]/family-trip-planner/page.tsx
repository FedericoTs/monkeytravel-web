      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'MonkeyTravel — Family Trip Planner',
        },
      ],
    },
    twitter: {
...
const COMPARISON_KEYS = ['kidFriendly', 'scheduling', 'dining', 'budget', 'routing'] as const;
const FAQ_KEYS = ['whatAges', 'isFree', 'howSafe', 'specialNeeds', 'multiFamily', 'destinations'] as const;

export default async function FamilyTripPlannerPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations('familyTripPlanner');
  const prefix = locale === 'en' ? '' : `/${locale}`;
  ...
  const breadcrumbItems = [
    ...
    {
      name: t('breadcrumbs.familyTripPlanner'),
      url: `${BASE_URL}${prefix}${PAGE_PATH}`,
    },
  ];
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="py-8 bg-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-16 text-center">
              ...
              <div className="hidden sm:block w-px h-12 bg-gray-200" />
              <div>
                <div className="text-3xl sm:text-4xl font-bold text-[var(--primary-ink)]">All Ages</div>
                <div className="text-sm text-[var(--foreground-muted)]">Kid-Friendly</div>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* ================================================================
            COMPARISON TABLE (MonkeyTravel vs Hours of Googling)
            ================================================================ */}
              ...
              {COMPARISON_KEYS.map((key, i) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-2 border-l border-gray-100 p-4 text-[var(--foreground-muted)]">
                    ...
                    <span>{t(`comparison.items.${key}.manual`)}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] mesh-gradient p-12 sm:p-16 lg:p-20">
              ...
              <div className="relative text-center">
                ...
                <div className="pt-8 border-t border-white/10 max-w-md mx-auto">
                  ...
                  <EmailSubscribe variant="dark" source="family-trip-planner-cta" />
                </div>
              </div>
            </div>
          </div>
