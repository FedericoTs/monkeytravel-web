        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-100 relative overflow-hidden">
          ...
          <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-5">
            ...
            <div className="relative group">
              ...
              {/* Edit overlay */}
              <button className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl flex items-center justify-center">
                  ...
                  {["Adventure", "Relaxation", "Cultural", "Foodie", "Romantic", "Budget", "Luxury", "Solo", "Family"].map((style) => (
                    <button
                      ...
                      className="px-3 py-1.5 rounded-full text-sm font-medium border-2 transition-all
                        ...
                        data-[selected=true]:border-[var(--primary)] data-[selected=true]:bg-[var(--primary)] data-[selected=true]:text-white"
                      data-selected={
                        (profile.preferences?.travelStyles as string[] | undefined)?.includes(style.toLowerCase()) || false
                      }
                    >
                      {style}
                    </button>
