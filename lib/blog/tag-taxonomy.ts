...
export const POSTS: Record<string, { c: string[]; d?: string[] }> = {
  ...
  "where-to-go-in-january":                { c: ["seasonal", "monthly-guide", "winter-travel", "best-destinations"] },
  "where-to-go-in-february":               { c: ["seasonal", "monthly-guide", "winter-travel", "best-destinations"] },
  "where-to-go-in-march":                  { c: ["seasonal", "monthly-guide", "spring-travel", "shoulder-season", "best-destinations"] },
