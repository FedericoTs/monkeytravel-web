...
export interface TripMeta {
  // Canonical destination name set by the wizard ("Rome", "Tokyo",
  // "Cusco"). Was always written into the JSONB but absent from this
  // interface until 2026-05-28 — see getTripDestination() in
  // lib/trips/destination.ts for why this matters (title-strip
  // fallback breaks for non-English/renamed trips).
  destination?: string;
