...
export default function MobileBottomNav({ activePage, tripId }: MobileBottomNavProps) {
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 sm:hidden z-50 pb-safe">
        <div className="flex items-center justify-around py-2">
          ...
          >
            ...
            <span className={`text-xs ${isActive("home") ? "font-medium" : ""}`}>Home</span>
          </Link>
          ...
          >
            ...
            <span className={`text-xs ${isActive("trips") || isActive("trip-detail") ? "font-medium" : ""}`}>My Trips</span>
          </Link>
          ...
          >
            ...
            <span className={`text-xs ${isActive("new") ? "font-medium" : ""}`}>New</span>
          </Link>
          ...
          >
            ...
            <span className={`text-xs ${isActive("profile") ? "font-medium" : ""}`}>Profile</span>
          </Link>
        </div>
      </nav>
