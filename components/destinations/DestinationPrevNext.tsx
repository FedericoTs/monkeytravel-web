  ...
  return (
    <nav className="my-12 grid sm:grid-cols-2 gap-4" aria-label="Destination navigation">
      {prev ? (
        ...
        >
          <span className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-slate-500 group-hover:text-[var(--primary-ink)] transition-colors">
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
            </svg>
            {prevLabel}
          </span>
          <h3 className="text-base font-semibold text-slate-900 group-hover:text-[var(--primary-ink)] transition-colors">
            {prev.name[locale]}
          </h3>
