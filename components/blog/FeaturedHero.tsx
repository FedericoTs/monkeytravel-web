...
/**
 * Magazine-style "editor's pick" hero card. Full-width image on left
 * (or top on mobile), oversized headline + lede on the right.
 *
 * Used as the first slot on the blog index above the curated lanes.
 */
    ...
    >
      <div className="grid md:grid-cols-2 gap-0 md:gap-0">
        <div className="relative aspect-[16/10] md:aspect-auto md:min-h-[420px] overflow-hidden">
          ...
          />
          {/* dark overlay on mobile so the eyebrow chip reads against the photo */}
