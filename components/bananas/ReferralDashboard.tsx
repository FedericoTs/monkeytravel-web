...
export default function ReferralDashboard({
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <button
        onClick={onShare}
        className="w-full bg-[var(--primary-ink)] text-white rounded-xl py-4 px-6 font-semibold flex items-center justify-center gap-2 hover:bg-[var(--primary-dark)] transition-colors"
      >
