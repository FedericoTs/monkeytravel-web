    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-slate-600">
          We'll suggest restaurants that match your needs
        </p>
      </div>
        ...
        {DIETARY_OPTIONS.map((diet) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <div className="font-medium text-slate-900">{diet.label}</div>
                <div className="text-sm text-slate-500">{diet.description}</div>
              </div>
              {isSelected && (
