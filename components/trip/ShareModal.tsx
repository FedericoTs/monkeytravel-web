      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="relative bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-900">{ts("title")}</h3>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="text-sm font-medium">{ts("platforms.twitter")}</span>
              </button>
              ...
              >
                ...
                <span className="text-sm font-medium">{ts("platforms.whatsapp")}</span>
              </button>
              ...
              >
                ...
                <span className="text-sm font-medium">{ts("platforms.email")}</span>
              </button>
            </div>
          </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {trendingEnabled
                        ? ts("explore.visibleInGallery")
                        : ts("explore.letOthersDiscover")}
                    </p>
                  </div>
                </div>
                <button
