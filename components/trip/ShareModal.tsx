          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="text-sm font-medium">{t("platforms.twitter")}</span>
              </button>
              ...
              >
                ...
                <span className="text-sm font-medium">{t("platforms.whatsapp")}</span>
              </button>
              ...
              >
                ...
                <span className="text-sm font-medium">{t("platforms.email")}</span>
              </button>
            </div>
          </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {trendingEnabled
                        ? t("explore.visibleInGallery")
                        : t("explore.letOthersDiscover")}
                    </p>
                  </div>
                </div>
                <button
