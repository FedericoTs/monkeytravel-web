...
export default function FeatureCard({
  ...
  return (
    ...
    >
      <div className="w-14 h-14 rounded-xl bg-[var(--accent)]/20 flex items-center justify-center text-[var(--primary-ink)] group-hover:bg-[var(--accent)] group-hover:text-[var(--foreground)] transition-colors mb-4">
        {icon}
      </div>
      ...
      <div className="mt-4 flex items-center text-[var(--primary-ink)] font-medium group-hover:text-[var(--accent-dark)] transition-colors">
